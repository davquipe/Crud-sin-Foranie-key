...
class List extends Component {
    ...
    handleClick = () => {
        this.props.history.push('/catalogo/almacenes/new');
    }
                            ...
                            <TableBody>
                                {list.map((d, index) =>
                                    <TableRow key={index}>
                                        ...
                                        <TableCell >
                                            <Link to={`/catalogo/almacenes/edit/${d.id}`} className="ui basic button green">Edit</Link>
